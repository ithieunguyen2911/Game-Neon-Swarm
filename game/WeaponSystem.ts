...
const BLASTER_TABLE: Record<number, WeaponStats> = {
  ...
  2:  { bullets: 2, damage: 11, hz: 5.0, overloadPerShot: 2.3 },
  3:  { bullets: 3, damage: 12, hz: 5.1, overloadPerShot: 2.4 },
  4:  { bullets: 4, damage: 13, hz: 5.1, overloadPerShot: 2.5 },
  5:  { bullets: 5, damage: 14, hz: 5.2, overloadPerShot: 2.6 },
  6:  { bullets: 5, damage: 15, hz: 5.3, overloadPerShot: 2.7 },
  7:  { bullets: 6, damage: 16, hz: 5.4, overloadPerShot: 2.8 },
  8:  { bullets: 6, damage: 17, hz: 5.5, overloadPerShot: 2.9 },
  9:  { bullets: 7, damage: 18, hz: 5.6, overloadPerShot: 3.0 },
  10: { bullets: 7, damage: 20, hz: 6.0, overloadPerShot: 3.2 },

  11: { bullets: 8, damage: 22, hz: 6.2, overloadPerShot: 3.4 },
  12: { bullets: 8, damage: 24, hz: 6.4, overloadPerShot: 3.6 },
  13: { bullets: 9, damage: 26, hz: 6.6, overloadPerShot: 3.8 },
  14: { bullets: 9, damage: 28, hz: 6.8, overloadPerShot: 4.0 },
  15: { bullets: 10, damage: 30, hz: 7.0, overloadPerShot: 4.2 },
  16: { bullets: 10, damage: 33, hz: 7.2, overloadPerShot: 4.3 },
  17: { bullets: 10, damage: 36, hz: 7.3, overloadPerShot: 4.4 },
  18: { bullets: 11, damage: 39, hz: 7.4, overloadPerShot: 4.5 },
  19: { bullets: 11, damage: 42, hz: 7.5, overloadPerShot: 4.6 },
  20: { bullets: 11, damage: 45, hz: 7.6, overloadPerShot: 4.8 },
};
